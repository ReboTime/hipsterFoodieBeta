...
let _grid = require('@material-ui/core');
...
let InfiniteScroll = function (_Component) {
  _inherits(InfiniteScroll, _Component);

  function InfiniteScroll(props) {
    _classCallCheck(this, InfiniteScroll);

    let _this = _possibleConstructorReturn(this, (InfiniteScroll.__proto__ || Object.getPrototypeOf(InfiniteScroll)).call(this, props));
  ...
  _createClass(InfiniteScroll, [{
    ...
    value: function componentDidUpdate() {
      if (this.props.isReverse && this.loadMore) {
        let parentElement = this.getParentElement(this.scrollComponent);
    ...
    value: function getParentElement(el) {
      let scrollParent = this.props.getScrollParent && this.props.getScrollParent();
    ...
    value: function scrollListener() {
      ...
      let scrollEl = window;
      let parentNode = this.getParentElement(el);
    ...
    value: function render() {
      ...
      let renderProps = this.filterProps(this.props);
      ...
      return _react2.default.createElement(_grid.Grid, props, childrenArray);
    }
  }]);
